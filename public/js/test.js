...
function maybeStart() {
    ...
    if(!isStarted && typeoflocalStream !== 'undefined' && isChannelReady) {
...
function createPeerConnection() {
    try {
        ...
        pc.onicecandidate = handlelceCandidate;
        pc.onremovestream = handelRemoteStreamRemoved;
...
function handelRemoteStreamRemoved(event) {
